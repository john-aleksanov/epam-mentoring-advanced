...
class PingServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ping = channel.unary_unary(
                '/com.epam.javamentoring.protocols.PingService/ping',
...
def add_PingServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'com.epam.javamentoring.protocols.PingService', rpc_method_handlers)
...
class PingService(object):
    ...
    def ping(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/com.epam.javamentoring.protocols.PingService/ping',
